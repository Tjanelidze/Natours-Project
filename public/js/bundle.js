  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51OsTuh08u1ffNgOEf4Exvtzp1qEIC8Y0a3PsqXjRcf8bTRZdvpeBCqSrdMPOcH1tTDgcG7cLSOZXKby9VIEWCY3f00HNuv5Zi9'); // 1) Get checkout session from API
          _context.next = 4;
